...
<table>
  ...
  <tbody>
    <tr>
      <td></td>
      <td>
      <img src="$$/logo.pgp.png" className="size-[24px] md:size-[30px] lg:size-[36px] inline" alt="PGP" />
      <img src="$$/logo.keybase.png"  className="size-[24px] md:size-[30px] lg:size-[36px] inline"  alt="Keybase" />
      </td>
      <td>
      <img src="$$/logo.signal.png" className="size-[24px] md:size-[30px] lg:size-[36px] inline" alt="Signal" />
      <img src="$$/logo.whatsapp.png"  className="size-[24px] md:size-[30px] lg:size-[36px] inline"  alt="WhatsApp" />
      <img src="$$/logo.telegram.png" className="size-[24px] md:size-[30px] lg:size-[36px] inline" alt="telegram" />
      </td>
    </tr>
    <tr>
